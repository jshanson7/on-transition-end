...
/***/ function(module, exports, __webpack_require__) {
	...
	var _materialColors = __webpack_require__(11);

	var _materialColors2 = _interopRequireDefault(_materialColors);

	var _prefixProperty = __webpack_require__(12);
	...
	function transitionLoop() {
	  $demoEl.css({
	    left: (0, _lodash.random)(document.documentElement.offsetWidth - elSize),
	    top: (0, _lodash.random)(document.documentElement.offsetHeight - elSize),
	    backgroundColor: randomColor()
	  });
	...
	function randomColor() {
	  return (0, _lodash.sample)((0, _lodash.sample)((0, _lodash.omit)(_materialColors2['default'], 'white', 'black')));
	}
