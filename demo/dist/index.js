...
/***/ function(module, exports, __webpack_require__) {
	...
	var _materialColors = __webpack_require__(16);

	var _materialColors2 = _interopRequireDefault(_materialColors);

	var _prefixProperty = __webpack_require__(17);
	...
	var elSize = 100;
	var $demoEl = (0, _jquery2['default'])('<div/>', {
	  css: _defineProperty({
	    position: 'absolute',
	    left: 0,
	    top: 0,
	  ...
	  }, (0, _prefixProperty2['default'])('transition'), 'left ' + transitionDuration + 'ms linear, top ' + transitionDuration + 'ms linear')
	});
	...
	(0, _jquery2['default'])('body').append($demoEl);

	setTimeout(transitionLoop, 1000);

	function transitionLoop() {
	  $demoEl.css('left', (0, _lodash.random)(document.documentElement.offsetWidth - elSize));
	  $demoEl.css('top', (0, _lodash.random)(document.documentElement.offsetHeight - elSize));
	  $demoEl.css('backgroundColor', randomColor());
	  (0, _2['default'])($demoEl[0], transitionDuration, transitionLoop);
	}

	function randomColor() {
	  return new _color2['default']((0, _lodash.sample)((0, _lodash.sample)((0, _lodash.omit)(_materialColors2['default'], 'white', 'black')))).rgbString();
	}
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */"use strict";var _Object$defineProperties=__webpack_require__(7)["default"];(function(global,factory){if(typeof module === "object" && typeof module.exports === "object"){ // For CommonJS and CommonJS-like environments where a proper `window`
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if (true) module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if (typeof exports === 'object') exports["onTransitionEnd"] = factory();else root["onTransitionEnd"] = factory();
	})(undefined, function () {
		return (/******/(function (modules) {
				// webpackBootstrap
				/******/ // The module cache
